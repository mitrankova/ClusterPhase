...
//std::string inFileName = "/sphenix/user/mitrankova/ClusterPhase/output_phase/Pi_G4sPHENIX_2evts_0_phase.root";
//snprintf(infileresid1, sizeof(infileresid1), "/sphenix/tg/tg01/hf/mitrankova/AuAu_2025_ClusterPhase/75396/Au_Au_Resid_200evts_0skip_75396-*_phase.root");
  ...
  std::string outfilename = "Sim_Fit_Pi_cluster_residual";
  ...
  */
  ...
  tree->SetBranchAddress("cluster_residual_rphi", &cluster_residual_rphi);
  ...
  for (Long64_t i = 0; i < nEntries; ++i)
  {
   ...
   // cout<<"hitside = "<<  hitside->at(0)<<" "<<hitside->back()<<endl;
    if ((hitside->at(0)!=1) ||( hitside->back()!=1)) continue; // select only clusters from side A
