    ...
    const int nSkip = 30)
{
 ...
 TRACKING::pp_mode = false;
  ...
  TString outfile = outdir + "output/"+ outfilename + "_" + runnumber + "-" + segment;
  std::string theOutfile = outfile.Data();
  TString outfile_resid = outdir + "output_resid/"+ outfilename + "_" + runnumber + "-" + segment;
  std::string theOutfile_resid = outfile_resid.Data();
  TString outfile_phase = outdir + "output_phase/"+ outfilename + "_" + runnumber + "-" + segment;
